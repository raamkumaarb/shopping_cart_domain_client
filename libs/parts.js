...
exports.devServer = function(options) {
  return {
    ...
    devServer: {
      ...
      contentBase: path.resolve(options.path)
    },
    plugins: [
...
exports.extractBundle = function(options) {
  ...
  return { // Define an entry point needed for splitting.
    entry: entry,
    plugins: [ // Extract bundle and manifest files. Manifest is needed for reliable caching. 
      new webpack.optimize.CommonsChunkPlugin({ names: [options.name, 'manifest']})
    ]
  }
}
